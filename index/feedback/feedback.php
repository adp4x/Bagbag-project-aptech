    ...
    <div class="container-fluid padding">
        <div class="row">
            <?php
                ...
                $query ='SELECT * FROM feedback limit 20';
            ...
            ?>
            <div class="col-12">
                <p style="margin-left:20px;"><b><h5> <?php echo $feedback['email']?> </h5></b></p>
                <p style="margin-left:20px;"><?php echo $feedback['content']?></p>
            </div>
            <?php
                        endwhile;
                    endif;
            ...
            <div class="col-lg-6">
                <form method='post' action="">
                    <h5 class="text-center">Feedback for us</h5>
                    <hr class="light">
                    <label for="email">Email:</label>
                    <input type="text" name='email' placeholder='abc@gmail.com' class='form-control' />
                    <label for="phone">Phone number:</label>
                    <input type="text" name='phone' placeholder='xxx-xxx-xxxx' class='form-control' />
                    <label for="content" style='margin-top:-50%;'>content:</label>
                    <textarea name="content" id="content" cols="80" rows="10" class='form-control'></textarea>
                    <input type="submit" name="Submit" class="btn btn-info"  value="Submit" style="margin-top:10px;"/>
                </form>
            </div>
            <?php
               if(isset($_POST['Submit'])){
                    ...
                    $sql3 = "INSERT INTO feedback(email,phonenumber,content) VALUES('".$email."','".$phone."','".$content."')";
                    ...
                    if ($query3) {
                        ...
                        echo '<script> location.replace("../order/error.php"); </script>';
                    }
                }
            ?>
        </div>
